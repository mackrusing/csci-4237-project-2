...
@Composable
private fun Login(navController: NavController, login: (String?) -> Unit) {
    ...
    // derived state
    val requestInProgress = loginRequested
    ...
    Column(
        ...
        Column(modifier = Modifier.width(IntrinsicSize.Min)) {
            ...
            Button(
                ...
                }, modifier = Modifier.fillMaxWidth(), enabled = !requestInProgress
            ) {
